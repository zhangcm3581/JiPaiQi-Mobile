...
Android 十三水两副牌手牌识别客户端（104 张，无大小王，每手 13 张）。当前版本 0.3.2，Android 8.0+、ARM64；旧版出牌记牌器保留在 `v1` 分支。APK 使用开发测试签名，未发布应用商店。

## 使用

1. 从 `dist/JiPaiQi-Mobile-0.3.2-debug-arm64.apk` 安装。
